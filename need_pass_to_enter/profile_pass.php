    ...
    <header>
      ...
      <div id="header" class="navbar navbar-default">
        ...
        <div style="border-top: dashed 1px rgb(85, 84, 85) ; margin-left: 15px; margin-right: 15px;">
          <p class="topicPath"><a href="index_pass.php" style="color: black;">Home</a> &gt; <a href="profile_pass.php">Profile</a></p>
        </div>
      </div>
    </header>
    <!-- ヘッダーここまで -->
    ...
    <div id="main" style="margin-left:20px; margin-right:20px;">
      <div class="row">
        ...
        <div class="col-sm-7 col-xs-12">
          ...
          $main_1 = $this_year - 1947;
          $main_2 = $this_year - 1946;
          $main_3 = $this_year - 1945;
            ?>
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title">期</h3>
            </div>
            <div class="panel-body">
              <div class="panel panel-default">
                <div class="panel-body">
                  <?php echo "<a href='profile/".$main_3."/profile-top.php' style='color :black;'>".$main_3."期"."</a>"; ?>
                </div>
              </div>
              <div class="panel panel-default">
                <div class="panel-body">
                  <?php echo "<a href='profile/".$main_2."/profile-top.php' style='color :black;'>".$main_2."期"."</a>"; ?>
                </div>
              </div>
              <div class="panel panel-default">
                <div class="panel-body">
                  <?php echo "<a href='profile/".$main_1."/profile-top.php' style='color :black;'>".$main_1."期"."</a>"; ?>
                </div>
              </div>
              <div class="panel panel-default">
                <div class="panel-body">
                <?php echo "<a href='profile/".$OB_1."/profile-top.php' style='color :black;'>".$OB_1."期"."</a>"; ?>
                </div>
              </div>
              <div class="panel panel-default">
                <div class="panel-body">
                <?php echo "<a href='profile/".$OB_2."/profile-top.php' style='color :black;'>".$OB_2."期"."</a>"; ?>
                </div>
              </div>
              <div class="panel panel-default">
                <div class="panel-body">
                <?php echo "<a href='profile/".$OB_3."/profile-top.php' style='color :black;'>".$OB_3."期"."</a>"; ?>
                </div>
              </div>
            </div>
          </div>
