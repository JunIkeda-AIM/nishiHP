    ...
    <header>
      ...
      <div id="header" class="navbar navbar-default">
        ...
        <div style="border-top: dashed 1px rgb(85, 84, 85) ; margin-left: 15px; margin-right: 15px;">
          <p class="topicPath"><a href="index_pass.php" style="color:black;">Home</a> &gt; <a href="pictures_pass.php" style="color: black;">Pictures</a></p>
        </div>
      </div>
    </header>
    <!-- ヘッダーここまで -->
      ...
      <div class="row">
        ...
        <div class="col-sm-7 col-xs-12">
          ...
          <div class="list-group">
            <a href="pictures/select_scene.php?year=2017-2018" class="list-group-item">2017-2018</a>
          </div>
        </div>
        <!-- メインコンテンツここまで -->
        <!-- サイドバー右 -->
