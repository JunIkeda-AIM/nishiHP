    ...
    <header>
      ...
      <div id="header" class="navbar navbar-default">
        ...
        <div style="border-top: dashed 1px rgb(85, 84, 85) ; margin-left: 15px; margin-right: 15px;">
          <p class="topicPath"><a href="../index_pass.php">Home</a> &gt; <a href="../pictures_pass.php" style="color: black;">Pictures</a> &gt; <a href="show_pictures.php">upload</a></p>
        </div>
      </div>
    </header>
    <!-- ヘッダーここまで -->
    ...
    <div id="main" style="margin-left:20px; margin-right:20px;">
      <div class="row">
        ...
        <div class="col-sm-7 col-xs-12">
          <?php
          $year = $_POST['year'];
          $dir = "/var/www/html/nishiHP/need_pass_to_enter/img/".$year."/";
          for ($i = 0; $i< count($_FILES["upfile"]["name"]); $i++) {
          	if (is_uploaded_file($_FILES["upfile"]["tmp_name"][$i])) {
          		$fileName = $dir.date("[Y-m-d_His]").$_FILES["upfile"]["name"][$i];
