    ...
    <div id="main" style="margin-left:20px; margin-right:20px;">
      <div class="row">
        ...
        <div class="col-sm-7 col-xs-12">
          <h3 class="subtitle">大西太一星（67期Fr陣）</h3>
          <p>趣味はサイクリング、旅行。1年の時の井草六校の表彰の時に一発ギャグをやりそれなりにウケたことが未だに忘れられない。
</p>
          <ul class="pager" style="float: bottom;">
            <li><a href="2.php" aria-label="前のページへ"><span aria-hidden="true">≪ 前へ</span></a></li>
            <li><a href="14.php" aria-label="次のページへ"><span aria-hidden="true">次へ ≫ </span></a></li>
          </ul>
        </div>
        <!-- メインコンテンツここまで -->
        <!-- サイドバー右 -->
