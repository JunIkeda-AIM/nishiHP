    ...
    <div id="main" style="margin-left:20px; margin-right:20px;">
      <div class="row">
        ...
        <div class="col-sm-7 col-xs-12">
          <h3 class="subtitle">部員紹介 メインOB</h3>
          <!--
          <ul>
          ...
          -->
          <ul>
            <li><a href="2.php">田中 恭平</a></li>
            <li><a href="4.php">大西 太一星</a></li>
            <li><a href="14.php">小西 健太</a></li>
            <li><a href="38.php">栗田 真之介</a></li>
            <li><a href="46.php">松本 航</a></li>
          </ul>
        </div>
        <!-- メインコンテンツここまで -->
        <!-- サイドバー右 -->
