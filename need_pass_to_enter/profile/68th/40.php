    ...
    <div id="main" style="margin-left:20px; margin-right:20px;">
      <div class="row">
        ...
        <div class="col-sm-7 col-xs-12">
          <h3 class="subtitle">田中 瑛介（68期Im・long陣）</h3>
          <p>実はピアノが弾ける。カラオケは罪深き趣味。毛を剃るとエースになれる。東進ハイスクール吉祥寺校の元社畜。現役を指導したいというよりは、俺がもう一度速くなりたいです。コース貸してください。よろしくお願いします。
</p>
          <ul class="pager" style="float: bottom;">
            <li><a href="#" class="disabled" aria-label="前のページへ"><span aria-hidden="true">≪ 前へ</span></a></li>
            <li><a href="25.php" aria-label="次のページへ"><span aria-hidden="true">次へ ≫ </span></a></li>
          </ul>
        </div>
        <!-- メインコンテンツここまで -->
        <!-- サイドバー右 -->
