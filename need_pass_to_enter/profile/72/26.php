    ...
    <div id="main" style="margin-left:20px; margin-right:20px;">
      <div class="row">
        ...
        <div class="col-sm-7 col-xs-12">
          <h3 class="subtitle">萩原陸登(72期)</h3>
          <p>しゃもじクラブ会長です。鶏肉とミルクティーが好き。誕生日は4月28日。趣味という趣味はありません。好きな色は薄ピンクと黒。体の約60パーセントは水です。あと、男です。</p>
          <ul class="pager" style="float: bottom;">
            <li><a href="#" class="disabled" aria-label="前のページへ"><span aria-hidden="true">≪ 前へ</span></a></li>
            <li><a href="27.php" aria-label="次のページへ"><span aria-hidden="true">次へ ≫ </span></a></li>
          </ul>
        </div>
        <!-- メインコンテンツここまで -->
        <!-- サイドバー右 -->
