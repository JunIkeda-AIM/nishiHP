    ...
    <div id="main" style="margin-left:20px; margin-right:20px;">
      <div class="row">
        ...
        <div class="col-sm-7 col-xs-12">
          <h3 class="subtitle">山野裕輝(72期)</h3>
          <p>水泳は小さいころからずっとやっていて、クラブチームに中3の9月まで所属していて泳いでいました。高校生活では、クラブチームはやめたので、部活の練習だけでレベルアップしたいです。S1は200FRを中心に泳いでいたので、FR中心で練習したいと思っています。みんなで和気藹々と楽しみたいです。はなしがずれますが、そろばんを習っていて、暗算が得意です。名前は好きなように呼んでもらってOKです。これからプールで会うときは、よろしくお願いします。</p>
          <ul class="pager" style="float: bottom;">
            <li><a href="29.php" aria-label="前のページへ"><span aria-hidden="true">≪ 前へ</span></a></li>
            <li><a href="31.php" aria-label="次のページへ"><span aria-hidden="true">次へ ≫ </span></a></li>
          </ul>
        </div>
        <!-- メインコンテンツここまで -->
        <!-- サイドバー右 -->
