    ...
    <div id="main" style="margin-left:20px; margin-right:20px;">
      <div class="row">
        ...
        <div class="col-sm-7 col-xs-12">
          <h3 class="subtitle">中田優太郎(72期)</h3>
          <p>学校のとき、水泳部に所属していて、おもに短距離のフリーとバッタによく出ていました。体力がないので長距離は苦手です。誕生日は1月5日好きな食べ物はうどんです。趣味は本や漫画を読むことです。よろしくお願いします。</p>
          <ul class="pager" style="float: bottom;">
            <li><a href="26.php" aria-label="前のページへ"><span aria-hidden="true">≪ 前へ</span></a></li>
            <li><a href="28.php" aria-label="次のページへ"><span aria-hidden="true">次へ ≫ </span></a></li>
          </ul>
        </div>
        <!-- メインコンテンツここまで -->
        <!-- サイドバー右 -->
