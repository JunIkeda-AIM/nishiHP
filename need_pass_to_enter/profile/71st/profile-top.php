    ...
    <div id="main" style="margin-left:20px; margin-right:20px;">
      <div class="row">
        ...
        <div class="col-sm-7 col-xs-12">
          <h3 class="subtitle">部員紹介 現役２年生</h3>
          <!--
          <ul>
            ...
            <?php// foreach ($stm as $row): ?>
              <li><a <?php // echo "href='".$row['id'].".php'"; ?>></a></li>
            <?php// endforeach ; ?>
          </ul>
          -->
          <ul>
            <li><a href="3.php">阿部 竣哉</a></li>
            <li><a href="5.php">石田 新一</a></li>
            <li><a href="6.php">當山 有衣</a></li>
            <li><a href="7.php">桑原 純礼</a></li>
            <li><a href="8.php">重村 隼也</a></li>
            <li><a href="9.php">中島 弥紀</a></li>
            <li><a href="10.php">松下 真菜</a></li>
            <li><a href="11.php">杉本 有紗</a></li>
            <li><a href="12.php">西島 大地</a></li>
            <li><a href="13.php">渡辺 雄一郎</a></li>
            <li><a href="15.php">平田 有理冴</a></li>
            <li><a href="16.php">長谷川 豪太</a></li>
            <li><a href="17.php">市原 梨香</a></li>
            <li><a href="18.php">菊間 岳拓</a></li>
            <li><a href="19.php">山西 隼</a></li>
            <li><a href="20.php">阿部 龍仁</a></li>
            <li><a href="21.php">佐久間 行生</a></li>
            <li><a href="22.php">藤生 剛平</a></li>
            <li><a href="23.php">杉山 未沙紀</a></li>
          </ul>
        </div>
        <!-- メインコンテンツここまで -->
        <!-- サイドバー右 -->
