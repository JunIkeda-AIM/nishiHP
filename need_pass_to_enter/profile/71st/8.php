    ...
    <div id="main" style="margin-left:20px; margin-right:20px;">
      <div class="row">
        ...
        <div class="col-sm-7 col-xs-12">
          <h3 class="subtitle">重村 隼也 (71期Fr陣)</h3>
          <p>水泳歴約4年。中学時代はテニス部。趣味はポケモン、ボウリング。バナナやラーメンなど、とにかく食べることが大好き。その結果、この1年で体重12kg増加。この夏は、タイムを縮められるよう本気で頑張ります。 </p>
          <ul class="pager" style="float: bottom;">
            <li><a href="7.php" aria-label="前のページへ"><span aria-hidden="true">« 前へ</span></a></li>
            <li><a href="9.php" aria-label="次のページへ"><span aria-hidden="true">次へ » </span></a></li>
          </ul>
        </div>
        <!-- メインコンテンツここまで -->
        <!-- サイドバー右 -->
