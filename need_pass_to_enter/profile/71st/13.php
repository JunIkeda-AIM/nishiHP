    ...
    <div id="main" style="margin-left:20px; margin-right:20px;">
      <div class="row">
        ...
        <div class="col-sm-7 col-xs-12">
          <h3 class="subtitle">渡辺雄一郎 (71期Br陣)</h3>
          <p>よろしくお願いします。</p>
          <ul class="pager" style="float: bottom;">
            <li><a href="12.php" aria-label="前のページへ"><span aria-hidden="true">« 前へ</span></a></li>
            <li><a href="15.php" aria-label="次のページへ"><span aria-hidden="true">次へ » </span></a></li>
          </ul>
        </div>
        <!-- メインコンテンツここまで -->
        <!-- サイドバー右 -->
