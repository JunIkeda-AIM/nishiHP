    ...
    <div id="main" style="margin-left:20px; margin-right:20px;">
      <div class="row">
        ...
        <div class="col-sm-7 col-xs-12">
          <h3 class="subtitle">阿部 竣哉（71期Br陣）</h3>
          <p>鍵隊所属。幼少から小5まで水泳を習っていた。中学の時の部活はバスケットボール部。趣味はテレビ・ラジオ・音楽など。</p>
          <ul class="pager" style="float: bottom;">
            <li><a href="#" class="disabled" aria-label="前のページへ"><span aria-hidden="true">« 前へ</span></a></li>
            <li><a href="5.php" aria-label="次のページへ"><span aria-hidden="true">次へ » </span></a></li>
          </ul>
        </div>
        <!-- メインコンテンツここまで -->
        <!-- サイドバー右 -->
