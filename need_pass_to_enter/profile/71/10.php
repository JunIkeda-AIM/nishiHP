    ...
    <div id="main" style="margin-left:20px; margin-right:20px;">
      <div class="row">
        ...
        <div class="col-sm-7 col-xs-12">
          <h3 class="subtitle">松下真菜 (71期br陣です)</h3>
          <p>中学ではバスケ部に所属してました。好きなことは寝ること。コミュ障で、自分からは話せませんがよろしくお願いします。</p>
          <ul class="pager" style="float: bottom;">
            <li><a href="9.php" aria-label="前のページへ"><span aria-hidden="true">« 前へ</span></a></li>
            <li><a href="11.php" aria-label="次のページへ"><span aria-hidden="true">次へ » </span></a></li>
          </ul>
        </div>
        <!-- メインコンテンツここまで -->
        <!-- サイドバー右 -->
