    ...
    <div id="main" style="margin-left:20px; margin-right:20px;">
      <div class="row">
        ...
        <div class="col-sm-7 col-xs-12">
          <h3 class="subtitle">石田新一（71期Fly陣）</h3>
          <p>あだ名はマイクです。小鳥を握るのが趣味です。よろしく。</p>
          <ul class="pager" style="float: bottom;">
            <li><a href="3.php" aria-label="前のページへ"><span aria-hidden="true">« 前へ</span></a></li>
            <li><a href="6.php" aria-label="次のページへ"><span aria-hidden="true">次へ » </span></a></li>
          </ul>
        </div>
        <!-- メインコンテンツここまで -->
        <!-- サイドバー右 -->
