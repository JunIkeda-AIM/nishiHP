    ...
    <div id="main" style="margin-left:20px; margin-right:20px;">
      <div class="row">
        ...
        <div class="col-sm-7 col-xs-12">
          <h3 class="subtitle">岩腰のぞみ(72期)</h3>
          <p>中学の部活はソフトテニス部でしたがゆるくやってて全然筋肉がないです。水泳経験は小学5年の夏までずっと通常クラスでスイミングスクールに通っていました。よろしくお願いします。</p>
          <ul class="pager" style="float: bottom;">
            <li><a href="32.php" aria-label="前のページへ"><span aria-hidden="true">≪ 前へ</span></a></li>
            <li><a href="34.php" aria-label="次のページへ"><span aria-hidden="true">次へ ≫ </span></a></li>
          </ul>
        </div>
        <!-- メインコンテンツここまで -->
        <!-- サイドバー右 -->
