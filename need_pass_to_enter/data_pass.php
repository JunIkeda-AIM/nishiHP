    ...
    <header>
      ...
      <div id="header" class="navbar navbar-default">
        ...
        <div style="border-top: dashed 1px rgb(85, 84, 85) ; margin-left: 15px; margin-right: 15px;">
          <p class="topicPath"><a href="../index_pass.php" style="color: black;">Home</a> &gt; <a href="../data_pass.php" style="color: black;">Data</a></p>
        </div>
      </div>
    </header>
    <!-- ヘッダーここまで -->
          ...
          <div class="row">
              <!-- サムネイル１ -->
            	<div class="col-xs-6 col-md-4">
            		<div class="thumbnail">
            			<img src="img/notepad-926046_640.jpg">
            			<div class="caption">
            				<h4>部員データ</h4>
            				<p>部員の情報を扱っています。</p>
            				<p><a href="data/team_member_pass.php" class="btn btn-info" role="button" target="_blank">進む</a></p>
            			</div>
            		</div>
            	</div>
              <!-- サムネイル１ここまで -->
              ...
              <div class="col-xs-6 col-md-4">
                <div class="thumbnail">
                  <img src="img/mainpool-01.jpg">
                  <div class="caption">
                    <h4>タイムレコード</h4>
                    <p>タイムを記録しています。</p>
                    <p><a href="data/record_pass.php" class="btn btn-info" role="button" target="_blank">進む</a></p>
                  </div>
                </div>
              </div>
              <!-- サムネイル２ここまで -->
            	<div class="col-xs-6 col-md-4">
            		<div class="thumbnail">
            			<img src="img/2016-11-24.png">
            			<div class="caption">
            				<h4>イノラン</h4>
            				<p>いのらんのタイムを扱っています。</p>
            				<p><a href="data/inorun_pass.php" class="btn btn-info" role="button" target="_blank">進む</a></p>
            			</div>
            		</div>
            	</div>
              <!-- サムネイル３ -->
